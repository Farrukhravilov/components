<template>
  ...
  >
    ...
    <div class="flex items-center justify-between gap-[20px] border-t border-gray-300 pt-[20px] ">
        <button class="rounded bg-green-600 text-white p-2 w-full" >Yakunlash</button>
        <button
          @click="toggleModal"
