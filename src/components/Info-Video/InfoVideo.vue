<template>
    <div class="mx-auto w-full max-w-[1320px] mt-[20px] pb-[80px]">
        <h2 class="text-white text-[22px] font-normal  uppercase">video qo'llanma</h2>
        <div class="flex justify-center items-center mt-[60px]">
            <div class="relative w-[80%] max-w-[100%] bg-gray-900 rounded-lg overflow-hidden shadow-lg">
