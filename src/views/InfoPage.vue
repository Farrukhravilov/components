<template>
  <div
    ...
    <Subtitle />
    <div class="flex items-center justify-between mx-auto w-full max-w-[1320px] pt-[130px] pb-[120px]">
      <!-- Card 1 -->
      <div class="flex flex-col gap-[60px] w-[23%]">
        <div ref="cardRefs"
          ...
          <img :src="`${url}media/b937c0a9-b808-475c-b52e-ad49dfc7445e-ideal.png`" alt="IDEAL Logo"
            class="w-full h-[180px] object-cover" />
        </div>
        <div ref="cardRefs"
          class="bg-white rounded-xl shadow-lg overflow-hidden transform transition duration-500 animate-fadeIn">
          <img :src="`${url}media/d4bddc68-f79c-4653-90d3-84891bafcbd9-dehqon-uz.png`" alt="Dehqon Logo"
            class="w-full h-[180px] object-cover" />
        </div>
      </div>
      <!-- Card 2 -->
      ...
      <div ref="cardRefs"
        ...
        <img :src="`${url}media/e6cf82e9-c17f-406f-af48-f41ddd369305-eco-bonu.png`" alt="Eco Bonu Logo"
      ...
      <div class="flex flex-col gap-[60px] w-[23%]">
        <div ref="cardRefs"
          class="bg-white rounded-xl shadow-lg overflow-hidden transform transition duration-500 animate-fadeIn">
          <img :src="`${url}media/516f54c0-45ad-4f06-8125-5a0b4b5e9310-effective-engineering.png`" alt="Effective Logo"
            class="w-full h-[180px] object-cover" />
        </div>
        <!-- Card 5 -->
        <div ref="cardRefs"
          class="bg-white rounded-xl shadow-lg overflow-hidden transform transition duration-500 animate-fadeIn">
          <img :src="`${url}media/b937c0a9-b808-475c-b52e-ad49dfc7445e-ideal.png`" alt="Another Logo"
            class="w-full h-[180px] object-cover" />
        </div>
      </div>
    </div>
    <div class="p-10 text-white mx-auto w-full max-w-[1320px]" data-aos="fade-down" data-aos-delay="1000">
      <h2 class="text-3xl font-bold text-center" data-aos="fade-down" data-aos-delay="1000">
      ...
      <div
        ...
        <!-- Progress Bar 1 -->
        <div class="text-center flex items-center gap-[5px]" data-aos="fade-up" data-aos-delay="1000">
          <div class="relative">
            <svg width="80" height="80" class="transform rotate-[-90deg]">
              <circle cx="40" cy="40" r="30" stroke="gray" stroke-width="8" fill="transparent" />
              <circle cx="40" cy="40" r="30" stroke="blue" stroke-width="8" fill="transparent" stroke-dasharray="188.4"
                stroke-dashoffset="70.62" class="transition duration-1000" />
            </svg>
            <span
              class="absolute left-1/2 top-1/2 text-white font-bold text-lg transform -translate-x-1/2 -translate-y-1/2">81%</span>
          </div>
          <p class="mt-2 text-white text-[18px]" data-aos="fade-down" data-aos-delay="1000" v-if="specificCategory3">
        ...
        <div class="text-center flex items-center gap-[5px]" data-aos="fade-up" data-aos-delay="1000">
          <div class="relative">
            <svg width="80" height="80" class="transform rotate-[-90deg]">
              <circle cx="40" cy="40" r="30" stroke="gray" stroke-width="8" fill="transparent" />
              <circle cx="40" cy="40" r="30" stroke="yellow" stroke-width="8" fill="transparent"
                stroke-dasharray="188.4" stroke-dashoffset="70.62" class="transition duration-1000" />
            </svg>
            <span
              class="absolute left-1/2 top-1/2 text-white font-bold text-lg transform -translate-x-1/2 -translate-y-1/2">78%</span>
          </div>
          <p class="mt-2 text-white text-[18px]" data-aos="fade-down" data-aos-delay="1000" v-if="specificCategory5">
            {{ specificCategory5.text }}
          </p>
        </div>
        <!-- Progress Bar 3 -->
        <div class="text-center flex items-center gap-[5px]" data-aos="fade-down" data-aos-delay="1000">
          <div class="relative">
            <svg width="80" height="80" class="transform rotate-[-90deg]">
              <circle cx="40" cy="40" r="30" stroke="gray" stroke-width="8" fill="transparent" />
              <circle cx="40" cy="40" r="30" stroke="green" stroke-width="8" fill="transparent" stroke-dasharray="188.4"
                stroke-dashoffset="70.62" class="transition duration-1000" />
            </svg>
            <span
              class="absolute left-1/2 top-1/2 text-white font-bold text-lg transform -translate-x-1/2 -translate-y-1/2">63%</span>
          </div>
          <p class="mt-2 text-white text-[18px] text-white" data-aos="fade-down" data-aos-delay="1000"
            v-if="specificCategory3">
            {{ specificCategory3.text }}
          </p>
        </div>
      </div>
      <img src="../assets/images/png/31040d80-0db7-42e5-8c62-681a9ae8a67c-Rectangle 15.png"
        class="w-[60%] mx-auto pt-[60px]" data-aos="fade-down" data-aos-delay="1000" alt="" />
    </div>
    <Users />
    <OnlyCards />
    <InfoVideo />
